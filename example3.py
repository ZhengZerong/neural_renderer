...
data_dir = os.path.join(current_dir, './examples/data')
...
class Model(nn.Module):
    def __init__(self, filename_obj, filename_ref):
        ...
        image_ref_2 = torch.from_numpy(imread(filename_ref[:-5] + '2.png').astype('float32') / 255.).permute(2,0,1)[None, ::]
...
def main():
    ...
    parser.add_argument('-ir', '--filename_ref', type=str, default=os.path.join(data_dir, 'example3_ref_1.png'))
